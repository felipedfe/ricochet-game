...
//   grabBall = () => {
//     console.log(this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2 < this.bar.x)
//     console.log(this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2, '/', this.bar.x)
//     console.log(this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2)
//     console.log('tem ser false', this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2 < this.bar.x)
...
//     console.log("----1----", this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2)
...
//     // console.log(this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2 < this.bar.x)
//     // console.log(this.scene.ball.ball.x, '/', this.bar.x)
//     // console.log(this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2)
//     // console.log('tem ser false', this.scene.ball.ball.x + this.scene.ball.ball.displayWidth / 2 < this.bar.x)
...
class GrabBar {
  ...
  constructor(x, initialY, finalY, scene, speed = 2000, lockThrowingDirection = false, ricochetLeft = false, ricochetRight = false) {
    ...
    this.topCollision.displayHeight = 10; // Ajuste conforme necessário
    // this.bottomCollision.displayWidth = this.bar.displayWidth;
    // this.bottomCollision.displayHeight = 10; // Ajuste conforme necessário
    ...
    // Animação da barra
    this.scene.tweens.add({
      targets: [this.bar, this.topCollision],
      y: this.finalY, // Altura final
      duration: this.speed,
      ease: "Linear",
      yoyo: true, // Repetir de volta para cima
